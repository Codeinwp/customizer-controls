 ...
 */
function font_selector_get_standard_fonts() {
	return apply_filters(
		'font_selector_standard_fonts_array', array(
 ...
 */
function font_selector_get_google_fonts_array() {
 ...
 * @since 1.1.38
 */
function font_selector_enqueue_google_font( $font ) {
