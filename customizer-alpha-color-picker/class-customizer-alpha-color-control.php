...
class Customizer_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			...
			get_template_directory_uri() . '/customizer-alpha-color-picker/js/alpha-color-picker.js',
		...
		wp_enqueue_style(
			'customizer-alpha-color-picker',
			get_template_directory_uri() . '/customizer-alpha-color-picker/css/alpha-color-picker.css',
