 ...
 * @access public
 */
class Customizer_Select_Multiple extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-select-multiple', get_template_directory_uri() . '/customizer-select-multiple/js/script-customizer-select-multiple.js', array( 'jquery', 'customize-base' ), MULTISELECT_VERSION, true );
